...
CUSTOM_HOST="${MNEMOSYNE_HOST:-}"
MNEMOSYNE_HOST="${MNEMOSYNE_HOST:-http://host.docker.internal:4001}"
MNEMOSYNE_KEY="${MNEMOSYNE_KEY:-}"

# Only run local fallback checks if no custom host was provided
